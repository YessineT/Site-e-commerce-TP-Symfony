 ...
 */
final class Version20250509210759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE download ADD hours_played DOUBLE PRECISION DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE game CHANGE slug slug VARCHAR(255) DEFAULT NULL, CHANGE release_date release_date DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE free_until free_until DATETIME DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            CREATE UNIQUE INDEX UNIQ_232B318C989D9B62 ON game (slug)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX UNIQ_232B318C989D9B62 ON game
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE game CHANGE slug slug VARCHAR(255) NOT NULL, CHANGE release_date release_date DATE NOT NULL, CHANGE free_until free_until DATE DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
